...
Route::post('payment/paystack', [PaypalController::class, 'paystack'])->name('paystack');
Route::get('payment/paystack/callback', [PaypalController::class, 'paystackCallback'])->name('paystack.callback');
